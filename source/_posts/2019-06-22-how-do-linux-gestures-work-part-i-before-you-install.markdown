...
So which shellcheck errors are justified? And what happens after you actually type make install? How does libinput gestures actually work? Find out [next time](/blog/2019/06/30/how-i-linked-my-3ds-as-my-controller-on-linux/) on my blog.
